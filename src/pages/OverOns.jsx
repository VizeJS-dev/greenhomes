        ...
        <>
            ...
            >
                ...
                <div
                    ...
                    id="onze-missie">
                    <div
                        className="flex flex-col gap-16 md:gap-0 max-w-[calc((100%_-_960px)/2_+_960px)] mr-0 ml-auto px-4 py-2 md:flex-row">
                        <div className="flex flex-col px-4 py-2">
                            <h2 className="text-3xl font-bold font-dm sm:text-4xl md:text-5xl">Onze Missie</h2>
                            <p className="text-base leading-relaxed font-k2d sm:text-lg md:text-xl md:leading-relaxed">
                ...
                <div
                    ...
                    id="ons-verhaal">
                    <div
                        className="flex flex-col gap-16 md:gap-0 max-w-[calc((100%_-_960px)/2_+_960px)] ml-0 mr-auto py-2 md:flex-row-reverse">
                        <div className="flex flex-col px-4 py-2">
                            <h2 className="text-3xl font-bold font-dm sm:text-4xl md:text-5xl">Ons Verhaal</h2>
